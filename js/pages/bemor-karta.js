        ...
        <div class="card !mb-0">
          ...
          <div class="card-body p-5">
            ...
            `: `
              ...
              ${p.nihss_qabul!=null ? Calculators.tavsiyaHtml(Calculators.nihssTavsiya(p.nihss_qabul, p.insult_turi, p.gcs_bali), p.nihss_qabul, 'NIHSS') : ''}
    ...
    showModal({
      ...
      body: `
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          ${(()=>{
            const mt = (p.muolaja_turi||'').toLowerCase();
            const showKt = Utils.msktDone(p.mskt) || mt.includes('mskt') || mt.includes('angiografiya');
